const TOOLS = {"hex-rgb-converter": {"title": "HEX to RGB Converter", "desc": "Convert HEX colors to RGB and HSL.", "category": "Color", "kind": "hexColor", "fields": [{"id": "hex", "label": "HEX color", "type": "text", "value": "#1f7a4d"}], "manual": false}, "rgb-hex-converter": {"title": "RGB to HEX Converter", "desc": "Convert RGB values to HEX and HSL.", "category": "Color", "kind": "rgbColor", "fields": [{"id": "r", "label": "Red", "type": "number", "value": 31}, {"id": "g", "label": "Green", "type": "number", "value": 122}, {"id": "b", "label": "Blue", "type": "number", "value": 77}], "manual": false}, "hsl-converter": {"title": "HSL Color Converter", "desc": "Convert HSL values to HEX and RGB.", "category": "Color", "kind": "hslColor", "fields": [{"id": "h", "label": "Hue", "type": "number", "value": 148}, {"id": "s", "label": "Saturation %", "type": "number", "value": 59}, {"id": "l", "label": "Lightness %", "type": "number", "value": 30}], "manual": false}, "contrast-checker": {"title": "Color Contrast Checker", "desc": "Check WCAG-style contrast ratio for text and background colors.", "category": "Accessibility", "kind": "contrast", "fields": [{"id": "fg", "label": "Text color", "type": "text", "value": "#172018"}, {"id": "bg", "label": "Background color", "type": "text", "value": "#fffdf4"}], "manual": false}, "palette-generator": {"title": "Palette Generator", "desc": "Generate tints, shades, complementary, and analogous colors.", "category": "Generators", "kind": "palette", "fields": [{"id": "hex", "label": "Base HEX color", "type": "text", "value": "#1f7a4d"}], "manual": false}, "gradient-generator": {"title": "CSS Gradient Generator", "desc": "Generate linear gradient CSS from two colors and an angle.", "category": "CSS", "kind": "gradient", "fields": [{"id": "from", "label": "Start color", "type": "text", "value": "#1f7a4d"}, {"id": "to", "label": "End color", "type": "text", "value": "#f2a541"}, {"id": "angle", "label": "Angle", "type": "number", "value": 135}], "manual": false}, "css-shadow-generator": {"title": "CSS Box Shadow Generator", "desc": "Generate box-shadow CSS with preview-friendly values.", "category": "CSS", "kind": "shadow", "fields": [{"id": "x", "label": "X offset", "type": "number", "value": 0}, {"id": "y", "label": "Y offset", "type": "number", "value": 18}, {"id": "blur", "label": "Blur", "type": "number", "value": 50}, {"id": "spread", "label": "Spread", "type": "number", "value": 0}, {"id": "color", "label": "Color", "type": "text", "value": "rgba(23,32,24,.15)"}], "manual": false}, "border-radius-generator": {"title": "Border Radius Generator", "desc": "Generate border-radius CSS for cards, buttons, and containers.", "category": "CSS", "kind": "radius", "fields": [{"id": "tl", "label": "Top left", "type": "number", "value": 24}, {"id": "tr", "label": "Top right", "type": "number", "value": 24}, {"id": "br", "label": "Bottom right", "type": "number", "value": 24}, {"id": "bl", "label": "Bottom left", "type": "number", "value": 24}], "manual": false}, "opacity-color-calculator": {"title": "Opacity Color Calculator", "desc": "Convert a HEX color and opacity to RGBA CSS.", "category": "Color", "kind": "opacity", "fields": [{"id": "hex", "label": "HEX color", "type": "text", "value": "#1f7a4d"}, {"id": "opacity", "label": "Opacity %", "type": "number", "value": 65}], "manual": false}, "css-clamp-generator": {"title": "CSS Clamp Font Size Generator", "desc": "Generate responsive clamp() CSS for typography.", "category": "CSS", "kind": "clamp", "fields": [{"id": "min", "label": "Min size px", "type": "number", "value": 18}, {"id": "max", "label": "Max size px", "type": "number", "value": 56}, {"id": "minvw", "label": "Min viewport px", "type": "number", "value": 360}, {"id": "maxvw", "label": "Max viewport px", "type": "number", "value": 1200}], "manual": false}, "color-blender": {"title": "Color Blender", "desc": "Blend two HEX colors by a chosen percentage.", "category": "Color", "kind": "blend", "fields": [{"id": "a", "label": "Color A", "type": "text", "value": "#1f7a4d"}, {"id": "b", "label": "Color B", "type": "text", "value": "#f2a541"}, {"id": "mix", "label": "Color B mix %", "type": "number", "value": 50}], "manual": false}, "css-filter-preview": {"title": "CSS Filter Builder", "desc": "Build simple CSS filter strings for image effects.", "category": "CSS", "kind": "filter", "fields": [{"id": "brightness", "label": "Brightness %", "type": "number", "value": 100}, {"id": "contrast", "label": "Contrast %", "type": "number", "value": 100}, {"id": "saturate", "label": "Saturate %", "type": "number", "value": 100}, {"id": "blur", "label": "Blur px", "type": "number", "value": 0}], "manual": false}, "hex-hsl-converter": {"title": "HEX to HSL Converter", "desc": "Convert HEX colors to HSL for design systems, CSS variables, and theme work.", "category": "Color", "kind": "hexColor", "fields": [{"id": "hex", "label": "HEX color", "type": "text", "value": "#2563eb"}], "manual": false}, "brand-palette-checker": {"title": "Brand Palette Checker", "desc": "Generate complementary, analogous, tint, and shade values from a brand color.", "category": "Generators", "kind": "palette", "fields": [{"id": "hex", "label": "Brand HEX color", "type": "text", "value": "#0f766e"}], "manual": false}, "text-background-contrast-checker": {"title": "Text Background Contrast Checker", "desc": "Check the contrast ratio between text and background colors for UI content.", "category": "Accessibility", "kind": "contrast", "fields": [{"id": "fg", "label": "Text color", "type": "text", "value": "#111827"}, {"id": "bg", "label": "Background color", "type": "text", "value": "#ffffff"}], "manual": false}, "button-contrast-checker": {"title": "Button Contrast Checker", "desc": "Check button label contrast against a button background color.", "category": "Accessibility", "kind": "contrast", "fields": [{"id": "fg", "label": "Button text color", "type": "text", "value": "#ffffff"}, {"id": "bg", "label": "Button background", "type": "text", "value": "#2563eb"}], "manual": false}, "hero-gradient-generator": {"title": "Hero Gradient Generator", "desc": "Generate a linear gradient CSS value for hero backgrounds and banners.", "category": "CSS", "kind": "gradient", "fields": [{"id": "from", "label": "Start color", "type": "text", "value": "#0f766e"}, {"id": "to", "label": "End color", "type": "text", "value": "#f59e0b"}, {"id": "angle", "label": "Angle", "type": "number", "value": 120}], "manual": false}, "card-shadow-generator": {"title": "Card Shadow Generator", "desc": "Create card-friendly box-shadow CSS for panels, cards, and floating controls.", "category": "CSS", "kind": "shadow", "fields": [{"id": "x", "label": "X offset", "type": "number", "value": 0}, {"id": "y", "label": "Y offset", "type": "number", "value": 12}, {"id": "blur", "label": "Blur", "type": "number", "value": 32}, {"id": "spread", "label": "Spread", "type": "number", "value": 0}, {"id": "color", "label": "Color", "type": "text", "value": "rgba(15, 23, 42, .16)"}], "manual": false}, "image-filter-css-builder": {"title": "Image Filter CSS Builder", "desc": "Build CSS filter strings for image previews, thumbnails, and simple visual effects.", "category": "CSS", "kind": "filter", "fields": [{"id": "brightness", "label": "Brightness %", "type": "number", "value": 105}, {"id": "contrast", "label": "Contrast %", "type": "number", "value": 110}, {"id": "saturate", "label": "Saturate %", "type": "number", "value": 115}, {"id": "blur", "label": "Blur px", "type": "number", "value": 0}], "manual": false}, "fluid-heading-clamp-generator": {"title": "Fluid Heading Clamp Generator", "desc": "Generate clamp() CSS for responsive headings and display text.", "category": "CSS", "kind": "clamp", "fields": [{"id": "min", "label": "Min size px", "type": "number", "value": 28}, {"id": "max", "label": "Max size px", "type": "number", "value": 72}, {"id": "minvw", "label": "Min viewport px", "type": "number", "value": 360}, {"id": "maxvw", "label": "Max viewport px", "type": "number", "value": 1280}], "manual": false}, "advanced-hex-rgb-converter": {"title": "Advanced HEX to RGB Converter", "desc": "Convert HEX colors to RGB and HSL. Use this focused variant for advanced workflows and long-tail search scenarios.", "category": "Color", "kind": "hexColor", "fields": [{"id": "hex", "label": "HEX color", "type": "text", "value": "#1f7a4d"}], "manual": false}, "quick-rgb-hex-converter": {"title": "Quick RGB to HEX Converter", "desc": "Convert RGB values to HEX and HSL. Use this focused variant for quick workflows and long-tail search scenarios.", "category": "Color", "kind": "rgbColor", "fields": [{"id": "r", "label": "Red", "type": "number", "value": 31}, {"id": "g", "label": "Green", "type": "number", "value": 122}, {"id": "b", "label": "Blue", "type": "number", "value": 77}], "manual": false}, "planning-hsl-converter": {"title": "Planning HSL Color Converter", "desc": "Convert HSL values to HEX and RGB. Use this focused variant for planning workflows and long-tail search scenarios.", "category": "Color", "kind": "hslColor", "fields": [{"id": "h", "label": "Hue", "type": "number", "value": 148}, {"id": "s", "label": "Saturation %", "type": "number", "value": 59}, {"id": "l", "label": "Lightness %", "type": "number", "value": 30}], "manual": false}, "mobile-contrast-checker": {"title": "Mobile Color Contrast Checker", "desc": "Check WCAG-style contrast ratio for text and background colors. Use this focused variant for mobile workflows and long-tail search scenarios.", "category": "Accessibility", "kind": "contrast", "fields": [{"id": "fg", "label": "Text color", "type": "text", "value": "#172018"}, {"id": "bg", "label": "Background color", "type": "text", "value": "#fffdf4"}], "manual": false}, "small-business-palette-generator": {"title": "Small Business Palette Generator", "desc": "Generate tints, shades, complementary, and analogous colors. Use this focused variant for small business workflows and long-tail search scenarios.", "category": "Generators", "kind": "palette", "fields": [{"id": "hex", "label": "Base HEX color", "type": "text", "value": "#1f7a4d"}], "manual": false}, "creator-gradient-generator": {"title": "Creator CSS Gradient Generator", "desc": "Generate linear gradient CSS from two colors and an angle. Use this focused variant for creator workflows and long-tail search scenarios.", "category": "CSS", "kind": "gradient", "fields": [{"id": "from", "label": "Start color", "type": "text", "value": "#1f7a4d"}, {"id": "to", "label": "End color", "type": "text", "value": "#f2a541"}, {"id": "angle", "label": "Angle", "type": "number", "value": 135}], "manual": false}, "student-css-shadow-generator": {"title": "Student CSS Box Shadow Generator", "desc": "Generate box-shadow CSS with preview-friendly values. Use this focused variant for student workflows and long-tail search scenarios.", "category": "CSS", "kind": "shadow", "fields": [{"id": "x", "label": "X offset", "type": "number", "value": 0}, {"id": "y", "label": "Y offset", "type": "number", "value": 18}, {"id": "blur", "label": "Blur", "type": "number", "value": 50}, {"id": "spread", "label": "Spread", "type": "number", "value": 0}, {"id": "color", "label": "Color", "type": "text", "value": "rgba(23,32,24,.15)"}], "manual": false}, "team-border-radius-generator": {"title": "Team Border Radius Generator", "desc": "Generate border-radius CSS for cards, buttons, and containers. Use this focused variant for team workflows and long-tail search scenarios.", "category": "CSS", "kind": "radius", "fields": [{"id": "tl", "label": "Top left", "type": "number", "value": 24}, {"id": "tr", "label": "Top right", "type": "number", "value": 24}, {"id": "br", "label": "Bottom right", "type": "number", "value": 24}, {"id": "bl", "label": "Bottom left", "type": "number", "value": 24}], "manual": false}, "audit-opacity-color-calculator": {"title": "Audit Opacity Color Calculator", "desc": "Convert a HEX color and opacity to RGBA CSS. Use this focused variant for audit workflows and long-tail search scenarios.", "category": "Color", "kind": "opacity", "fields": [{"id": "hex", "label": "HEX color", "type": "text", "value": "#1f7a4d"}, {"id": "opacity", "label": "Opacity %", "type": "number", "value": 65}], "manual": false}, "checklist-css-clamp-generator": {"title": "Checklist CSS Clamp Font Size Generator", "desc": "Generate responsive clamp() CSS for typography. Use this focused variant for checklist workflows and long-tail search scenarios.", "category": "CSS", "kind": "clamp", "fields": [{"id": "min", "label": "Min size px", "type": "number", "value": 18}, {"id": "max", "label": "Max size px", "type": "number", "value": 56}, {"id": "minvw", "label": "Min viewport px", "type": "number", "value": 360}, {"id": "maxvw", "label": "Max viewport px", "type": "number", "value": 1200}], "manual": false}, "campaign-color-blender": {"title": "Campaign Color Blender", "desc": "Blend two HEX colors by a chosen percentage. Use this focused variant for campaign workflows and long-tail search scenarios.", "category": "Color", "kind": "blend", "fields": [{"id": "a", "label": "Color A", "type": "text", "value": "#1f7a4d"}, {"id": "b", "label": "Color B", "type": "text", "value": "#f2a541"}, {"id": "mix", "label": "Color B mix %", "type": "number", "value": 50}], "manual": false}, "batch-css-filter-preview": {"title": "Batch CSS Filter Builder", "desc": "Build simple CSS filter strings for image effects. Use this focused variant for batch workflows and long-tail search scenarios.", "category": "CSS", "kind": "filter", "fields": [{"id": "brightness", "label": "Brightness %", "type": "number", "value": 100}, {"id": "contrast", "label": "Contrast %", "type": "number", "value": 100}, {"id": "saturate", "label": "Saturate %", "type": "number", "value": 100}, {"id": "blur", "label": "Blur px", "type": "number", "value": 0}], "manual": false}};
